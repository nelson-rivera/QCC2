...
<head>
	...
	<title>QCC - Listado de Rubro de Clientes[Mantenimiento]</title>
	<?= css_fonts() ?>
...
<body>
	...
	<div class="container-fluid" id="pcont">
            <div class="page-head">
                <h2>Mantenimiento <i class="fa fa-angle-double-right"></i> Rubros de Clientes</h2>
            </div>
            <div class="cl-mcont">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="block-flat">
                            <table class="table table-bordered" id="datatable-icons" >
                                ...
                                <tbody>
                                <?php 
                                $query=$connection->prepare(sql_select_rubros_clientes_all());
                                $query->execute();
                                ...
                                ?>
                                    <tr class="odd gradeA">
                                        <td id="cat_<?= $num ?>" ><?= $value['rubro'] ?></td>
                                        <td class="center">
                                            <a class="btn btn-primary md-trigger btn-xs btn-edit-cat" data-toggle="tooltip" data-original-title="Editar registro" data-modal="mod-edit" data-cat="<?= encryptString($value['idrubro']) ?>"  data-num="<?= $num ?>" >
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a class="btn btn-danger md-trigger btn-xs btn-eliminar-cat" data-toggle="tooltip" data-original-title="Eliminar registro" data-modal="mod-delete" data-cat="<?= encryptString($value['idrubro']) ?>"  data-num="<?= $num ?>" >
                            ...
                            <div class="md-content ">
                              ...
                              <div class="modal-body">
                                <div id="modal-body-center-edit" class="text-center">
                                  <form name="frm-edit-cat" id="frm-edit-cat" class="form-horizontal" style="border-radius: 0px;" onkeypress="return anular(event)" >
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Rubro</label>
                                        <div class="col-sm-6">
                                            <input class="form-control" type="text" name="rubroEditar" id="rubroEditar" required >
                                        </div>
                                    </div>
                                  </form>
                                </div>
                            ...
                            <div class="md-content ">
                              ...
                              <div class="modal-body">
                                <div id="modal-body-center-add" class="text-center">
                                  <form name="frm-add-cat" id="frm-add-cat" class="form-horizontal" style="border-radius: 0px;" onkeypress="return anular(event)" >
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Rubro</label>
                                        <div class="col-sm-6">
                                            <input class="form-control" type="text" name="rubroAgregar" id="rubroAgregar" required >
                                        </div>
                                    </div>
                                  </form>
                                </div>
...
<script type="text/javascript">
      $(document).ready(function(){
        ...
        $('.btn-eliminar-cat').click(function(e){
           ...
           $("#del_name").html( $("#cat_"+num).html());
           $("#btn-deleteS").attr("data-cat", $(this).attr("data-cat") )
        });
        
        $('.btn-edit-cat').click(function(e){
           var num = $(this).attr("data-num");
           $("#rubroEditar").val( $("#cat_"+num).html());
           $("#btn-editS").attr("data-cat", $(this).attr("data-cat"));
        });
        ...
        $('#btn-deleteS').click(function(e){
           var cat = $("#btn-deleteS").attr("data-cat");
           $.ajax({
                url:"ajax/clients-category.php",
                type:'POST',
                dataType:"json",
                data:"option=delete&cat="+cat,
        ...
        $('#btn-editS').click(function(e){
         $(this).attr("disabled","disabled"); 
           var cat = $("#btn-editS").attr("data-cat");
           $.ajax({
                url:"ajax/clients-category.php",
                type:'POST',
                dataType:"json",
                data:"option=update&cat="+cat+"&"+$("#frm-edit-cat").serialize(),
                beforeSend: function(){ $("#modal-footer-response").html(''); },
                success:function(data){
                    if(data.status=="1"){ 
        ...
        $('#btn-addS').click(function(e){
         $(this).attr("disabled","disabled");   
           $.ajax({
                ...
                type:'POST',
                dataType:"json",
                data:"option=add&"+$("#frm-add-cat").serialize(),
                beforeSend: function(){ $("#modal-footer-response").html(''); },
                success:function(data){
                    if(data.status=="1"){ 
