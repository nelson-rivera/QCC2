...
<head>
	...
	<title>QCC - Listado de Cargos de contactos[Mantenimiento]</title>
	<?= css_fonts() ?>
...
<body>
	...
	<div class="container-fluid" id="pcont">
            <div class="page-head">
                <h2>Mantenimiento <i class="fa fa-angle-double-right"></i> Cargos de contactos</h2>
            </div>
            <div class="cl-mcont">
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="md-content ">
                              ...
                              <div class="modal-body">
                                <div id="modal-body-center-edit" class="text-center">
                                    <form name="frm-edit-pcon" id="frm-edit-pcon" class="form-horizontal" style="border-radius: 0px;"  onkeypress="return anular(event)" >
                            ...
                            <div class="md-content ">
                              ...
                              <div class="modal-body">
                                <div id="modal-body-center-add" class="text-center">
                                  <form name="frm-add-pcon" id="frm-add-pcon" class="form-horizontal" style="border-radius: 0px;"  onkeypress="return anular(event)" >
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Cargo</label>
                                        <div class="col-sm-6">
 ...
 <script type="text/javascript">
      $(document).ready(function(){
        ...
        $('.btn-edit-pcon').click(function(e){
           var num = $(this).attr("data-num");
           $("#cargoEditar").val( $("#pcon_"+num).html());
           $("#btn-editS").attr("data-pcon", $(this).attr("data-pcon"));
        });
        
        $('.btn-add-pcon').click(function(e){
           $("#btn-editS").attr("data-pcon", $(this).attr("data-pcon"));
        });
        ...
        $('#cargoEditar').keydown(function(event) {
            if (event.keyCode == 13) {
        ...
        $('#cargoAgregar').keydown(function(event) {
            if (event.keyCode == 13) {
