                    ...
                    <div class="col-md-12">
                        <div class="block-flat">
                            <table class="table table-bordered" id="datatable-icons" >
                                ...
                                ?>
                                    <tr class="odd gradeA">
                                        <td id="tsup_<?= $num ?>" ><?= $value['rubro'] ?></td>
                                        <td class="center">
                                            <a class="btn btn-primary md-trigger btn-xs btn-edit-tsup" data-toggle="tooltip" data-original-title="Eliminar registro" data-modal="mod-edit" data-tsup="<?= encryptString($value['idrubro']) ?>"  data-num="<?= $num ?>" >
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a class="btn btn-danger md-trigger btn-xs btn-eliminar-tsup" data-toggle="tooltip" data-original-title="Eliminar registro" data-modal="mod-delete" data-tsup="<?= encryptString($value['idrubro']) ?>"  data-num="<?= $num ?>" >
