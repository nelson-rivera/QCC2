...
<body>
	...
	<div class="container-fluid" id="pcont">
            <div class="page-head">
                <h2>Mantenimiento <i class="fa fa-angle-double-right"></i> Sub-rubros de Proveedores</h2>
            </div>
            <div class="cl-mcont">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="block-flat">
                            <table class="table table-bordered" id="datatable-icons" >
                                ...
                                ?>
                                    <tr class="odd gradeA">
                                        <td id="subcat_<?= $num ?>" ><?= $value['sub_rubro'] ?></td>
                                        <td class="center">
                                            <a class="btn btn-primary md-trigger btn-xs btn-edit-subcat" data-toggle="tooltip" data-original-title="Eliminar registro" data-modal="mod-edit" data-subcat="<?= encryptString($value['idsub_rubro']) ?>"  data-num="<?= $num ?>" >
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a class="btn btn-danger md-trigger btn-xs btn-eliminar-subcat" data-toggle="tooltip" data-original-title="Eliminar registro" data-modal="mod-delete" data-subcat="<?= encryptString($value['idsub_rubro']) ?>"  data-num="<?= $num ?>" >
                            ...
                            <div class="md-content ">
                              ...
                              <div class="modal-body">
                                <div id="modal-body-center-edit" class="text-center">
                                    <form name="frm-edit-subcat" id="frm-edit-subcat" class="form-horizontal" style="border-radius: 0px;"  onkeypress="return anular(event)" >
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Subrubro</label>
                                        <div class="col-sm-6">
                                            <input class="form-control" type="text" name="subrubroEditar" id="subrubroEditar" required >
                                        </div>
                                    </div>
                                  </form>
                                </div>
                            ...
                            <div class="md-content ">
                              ...
                              <div class="modal-body">
                                <div id="modal-body-center-add" class="text-center">
                                  <form name="frm-add-subcat" id="frm-add-subcat" class="form-horizontal" style="border-radius: 0px;"  onkeypress="return anular(event)" >
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Sub-Rubro</label>
                                        <div class="col-sm-6">
                                            <input class="form-control" type="text" name="subrubroAgregar" id="subrubroAgregar" required >
                                        </div>
                                    </div>
                                  </form>
                                </div>
 ...
 <script type="text/javascript">
      $(document).ready(function(){
        ...
        $('.btn-eliminar-subcat').click(function(e){
           var num = $(this).attr("data-num");
           $("#del_name").html( $("#subcat_"+num).html());
           $("#btn-deleteS").attr("data-subcat", $(this).attr("data-subcat") )
        });
        
        $('.btn-edit-subcat').click(function(e){
           var num = $(this).attr("data-num");
           $("#subrubroEditar").val( $("#subcat_"+num).html());
           $("#btn-editS").attr("data-subcat", $(this).attr("data-subcat"));
        });
        
        $('.btn-add-subcat').click(function(e){
           $("#btn-editS").attr("data-subcat", $(this).attr("data-subcat"));
        });
        
        $('#btn-deleteS').click(function(e){
           $(this).attr("disabled","disabled");
           var subcat = $("#btn-deleteS").attr("data-subcat");
           $.ajax({
                url:"ajax/supplier-subcategory.php",
                type:'POST',
                dataType:"json",
                data:"option=delete&subcat="+subcat,
        ...
        $(this).attr("disabled","disabled");
           var subcat = $("#btn-editS").attr("data-subcat");
           $.ajax({
                url:"ajax/supplier-subcategory.php",
                type:'POST',
                dataType:"json",
                data:"option=update&subcat="+subcat+"&"+$("#frm-edit-subcat").serialize(),
                beforeSend: function(){ $("#modal-footer-response").html(''); },
                success:function(data){
                    if(data.status=="1"){ 
        ...
        $(this).attr("disabled","disabled");   
           $.ajax({
                ...
                type:'POST',
                dataType:"json",
                data:"option=add&"+$("#frm-add-subcat").serialize(),
                beforeSend: function(){ $("#modal-footer-response").html(''); },
                success:function(data){
                    if(data.status=="1"){ 
        ...
        $('#subrubroEditar').keydown(function(event) {
            if (event.keyCode == 13) {
        ...
        $('#subrubroAgregar').keydown(function(event) {
            if (event.keyCode == 13) {
